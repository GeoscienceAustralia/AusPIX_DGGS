# -*- coding: utf-8 -*-
'''
This code calculates all the AusPIX cells in a polygon at the various resolutions depending on size of poly.
...
def poly_to_DGGS_tool(myPoly, resolution):  # one poly and the attribute record for it
    ...
    stradleX = 0
    #print('call record', thisRecord)   # get some info out of the first record
    ...
    # call function to calculate all the cells within the bounding box
    ...
    #for i in parts[-2]:
        ...
        # for item in thisPolyPoints:
        #    print('thisPolyPoints', item)
        print(len(thisPolyPoints))
...
if __name__ == '__main__':
    ...
    # note this dosn't run if called froom another module

    testPoly = r"\\prod.lan\active\ops\nlib\NLI Reform Project\Place Names Linked Data Project\WaterBodiesNeo\Irrigated_Areas\SampleTest_Irrigation.shp"

    # testPoly = r'\\prod.lan\active\ops\nlib\NLI Reform Project\Place Names Linked Data Project\WaterBodiesNeo\Irrigated_Areas\SimpleSampleTest_Irrigation_SinglePart.shp'
    # read in the file
    ...
    for fea in irrPolys:  # for feature in attribute table
            ...
            cells = poly_to_DGGS_tool(fea.shape, 9)  # start at DGGS level 8
